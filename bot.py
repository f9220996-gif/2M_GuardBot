...
print("✅ ربات M2_GuardBot با گیف بن و استیکر بن روشن شد!")
                ...
                if chat_type != "private":
                    for new_member in msg["new_chat_members"]:
                        ...
                        if uid_new and uid_new != OWNER_ID:
                            ...
                            send_msg_keep(chat_id, welcome_text, reply_to=msg_id)
                continue
