...
# ====== هوش مصنوعی (با کلید جدید) ======
AI_API_KEY = "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"
...
while True:
    try:
        ...
        for update in r.get("result", []):
            ...
            # ====== هوش مصنوعی برای OWNER ======
            if user_id == OWNER_ID and chat_type != "private":
                # اگه دستور مدیریتی نباشه
                if text not in ["خاموشی", "روشن", "تاریخ", "پاک", "گیف بن", "استیکر بن", "بن کن", "آزاد کن"] and not text.startswith("سکوت") and not text.startswith("/"):
