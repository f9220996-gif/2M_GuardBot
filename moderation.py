...
from permissions import can_use_moderation_commands, can_target_user, parse_duration_seconds
from persian_date import build_restriction_message, build_duration_text
