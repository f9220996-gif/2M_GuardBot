...
from start import cmd_start, on_help_button, send_start_panel, BACK_BUTTON_TEXT
...
def main():
    ...
    # ---- گیف/استیکر ارسالی در پی‌وی (برای ذخیره‌ی گیف/استیکر خوش‌آمدگویی) ----
    app.add_handler(MessageHandler(
        filters.ChatType.PRIVATE & (filters.Sticker.ALL | filters.ANIMATION), receive_welcome_media
    ))
