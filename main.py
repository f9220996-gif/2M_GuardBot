...
from handlers.start import cmd_start, on_help_button
...
from handlers.bad_words_filter import check_message_for_bad_words
...
async def on_start_menu_button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    from handlers.start import build_start_keyboard, START_TEXT
